...
const Navigation = () => {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex w-64 flex-col fixed inset-y-0 bg-white/90 backdrop-blur-xl border-r border-gray-100 shadow-lg z-30">
        {/* Header */}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="mobile-menu-toggle p-2 text-gray-600 hover:text-orange-600 rounded-lg hover:bg-orange-50 transition-colors"
            >
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-50 bg-black/50 backdrop-blur-sm">
          <div className="mobile-nav-menu fixed inset-y-0 right-0 w-80 max-w-[85vw] bg-white/95 backdrop-blur-xl border-l border-gray-100 shadow-2xl overflow-y-auto">
            {/* Mobile Menu Header */}
